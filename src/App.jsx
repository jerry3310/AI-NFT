...
// Constants
const TWITTER_HANDLE = 'luoluo3310';
...
//const NFT_ADDRESS = '0x65d8e0e9acfbea2aab8d7c0c8831c8a33b21040407b125ff0b8852afebd7bb6'
const App = () => {
  ...
  const claimNFT = async () => {
	...
	return (
		<div className="App">
          ...
          <header>
            <div className="left">
              <p className="title">✨ AI NFT</p><br></br>
              <p className="subtitle">Create a unique avatar NFT using AI technology for you.</p>
            </div>
